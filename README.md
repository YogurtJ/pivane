...
**下一版 1.1.0 候选已适配 Pi 0.87.1**，整合项目文件浏览、任务进度卡、跨设备模型收藏与手机交互优化，见[候选版本说明](docs/releases/1.1.0.md)。这不改变已发布的 1.0.0/Pi 0.86.1 归档；实际发布以 Release 为准，运行实例需经正常更新流程切换后生效。
