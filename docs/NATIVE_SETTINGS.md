...
扩展助手提供办公文档、分析 Excel、检查更新、排查扩展四个需求气泡；“检查更新”要求先核对所有已安装 Packages/Skills 的范围、来源与当前版本，再查询更新、变化与兼容性并提出方案，对无法核对版本的项目明确标注，等用户确认后才更新。点击气泡只填写需求，不自动查询、安装或执行更新。办公文档使用中英文通用 Word/PDF 检查与安装方案文案，制作 PPT 由精选入口提供。
