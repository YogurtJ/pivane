...
const files = [
    ...
    'config/media-lab.json', 'config/tts-providers.json', 'scripts/package-trial.cjs', 'scripts/access-reset.cjs', 'scripts/run-tests.cjs', 'scripts/start-managed.cjs', 'scripts/restore-managed-backup.cjs',
